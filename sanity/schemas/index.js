...
const credentialsPage = {
  ...
  fields: [
    ...
    { name: "focusStatusBadge", title: "Focus Status Badge", type: "string" },
    { name: "focusEyebrow", title: "Focus Eyebrow", type: "string" },
    ...
    { name: "focusDate", title: "Focus Date", type: "string" },
    { name: "focusLocation", title: "Focus Location", type: "string" },
    ...
    { name: "focusSpecializationsHeading", title: "Focus Specializations Heading", type: "string" },
    {
      name: "focusSpecializations",
      title: "Focus Specializations",
      type: "array",
      of: [{ type: "string" }],
    },
    { name: "focusHighlightTitle", title: "Focus Highlight Title", type: "string" },
    { name: "focusHighlightSubtitle", title: "Focus Highlight Subtitle", type: "string" },
