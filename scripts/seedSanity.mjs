...
const run = async () => {
  ...
  await createOrReplace({
    ...
    focusStatusBadge: "Active Status: Q4 2024",
    focusEyebrow: "Executive Leadership",
    ...
    focusDate: "09/2023 — Present",
    focusLocation: "Addis Ababa, Ethiopia",
    focusBody:
      "I currently work on interpretable AI, production ML systems, MLOps, and low-latency deployed applications across healthcare, NLP, and computer vision. My focus remains on bridging the gap between theoretical research and impactful, real-world deployments.",
    ...
    focusSpecializationsHeading: "Key Specializations",
    focusSpecializations: [
      "Echocardiography-based RHD screening",
      "EEG seizure detection",
      "Wheat leaf disease classification",
      "Ethiopian language AI tools",
    ],
    focusHighlightTitle: "Advanced MLOps",
    focusHighlightSubtitle: "Deploying low-latency systems at scale",
    education: [
      {
        _type: "educationItem",
